...
const ground = new GameObject(new Vector(0, Game.Settings.NativeHeight - 150), new Vector(Game.Settings.NativeWidth, 150), true);
ground.colour = "darkgreen";

const leftBorder = new GameObject(new Vector(-150, -150), new Vector(150, Game.Settings.NativeHeight + 300), true);
const rightBorder = new GameObject(new Vector(Game.Settings.NativeWidth, -150), new Vector(150, Game.Settings.NativeHeight + 300), true);
const topBorder = new GameObject(new Vector(0, -150), new Vector(Game.Settings.NativeWidth - 150, 150), true);
