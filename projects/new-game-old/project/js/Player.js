...
class Player extends Entity {
    ...
    constructor(position) {
        super(position, animations, "Player", 500, 850);
    ...
    Update = (delta) => {
        ...
        for (let block of Game.World.fg_blocks) {
            ...
            if (RectIntersection(nextFrameX, blockHitbox)) {
                if (this.vel.x > 0) this.vel.x = (blockHitbox.left() - this.right()) / delta;
                else if (this.vel.x < 0) this.vel.x = (blockHitbox.right() - this.left()) / delta;
