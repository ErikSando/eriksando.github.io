...
function RectAndLineIntersection(r, l) {
    ...
    let rSides = [
        { start: Vector(r.position.x, r.position.y), end: Vector(r.position.x + r.scale.x, r.position.y) },
        { start: Vector(r.position.x + r.scale.x, r.position.y), end: Vector(r.position.x + r.scale.x, r.position.y + r.scale.y) },
        { start: Vector(r.position.x + r.scale.x, r.position.y + r.scale.y), end: Vector(r.position.x, r.position.y + r.scale.y) },
        { start: Vector(r.position.x, r.position.y + r.scale.y), end: Vector(r.position.x, r.position.y) }
    ]
...
function RectAndTriangleIntersection(r, t) {
    ...
    let tSides = [
        { start: Vector(t.a.x, t.a.y), end: Vector(t.b.x, t.b.y) },
        { start: Vector(t.b.x, t.b.y), end: Vector(t.c.x, t.c.y) },
        { start: Vector(t.c.x, t.c.y), end: Vector(t.a.x, t.a.y) }
    ]
