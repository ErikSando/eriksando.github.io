...
function LoadSpritesheet(image, tileSize, columns = 1, rows = 1, tiles, start = Vector.zero()) {
...
class GameObject {
    ...
    constructor(position = Vector.zero(), scale = new Vector(50, 50), anchored = false, collidable = true, useGravity = true) {
        this.position = position;
        this.scale = scale;
